...
* @date 2024-03-04 08:58
* @version 1.0
*/
public class Classic024_String_Greedy {
	public static void main(String[] args) {
		Classic024_String_Greedy cc05 = new Classic024_String_Greedy();
		String[] words = {"This", "is", "an", "example", "of", "text", "justification."};
		int maxWidth = 16;
		System.out.println(cc05.fullJustify(words, maxWidth));
	}
