 ...
 * @version 1.0
 */
public class Classic096_Graph_BFS_WordJieLong2 {
	public static void main(String[] args) {
		Classic096_Graph_BFS_WordJieLong2 c96 = new Classic096_Graph_BFS_WordJieLong2();
	...
	int bfs() {
		...
		/*
		 * m1 和 m2 分别记录两个方向出现的单词是经过多少次转换而来 e.g. m1 = {"abc":1} 代表 abc 由 beginWord 替换 1
		 * 次字符而来 m2 = {"xyz":3} 代表 xyz 由 endWord 替换 3 次字符而来
		 */
		...
		/*
		 * 只有两个队列都不空，才有必要继续往下搜索 如果其中一个队列空了，说明从某个方向搜到底都搜不到该方向的目标节点 e.g. 例如，如果 d1 为空了，说明从
		 * beginWord 搜索到底都搜索不到 endWord，反向搜索也没必要进行了
		 */
